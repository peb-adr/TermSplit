...
namespace LiveSplitCore
{
    ...
    public class DetailedTimerComponentStateRef
    {
        ...
        public string SegmentName()
        {
            ...
            var result = LiveSplitCoreNative.DetailedTimerComponentState_segment_name(this.ptr).AsString();
            return result;
        }
    ...
    public class FuzzyListRef
    {
        ...
        public string Search(string pattern, long max)
        {
            ...
            var result = LiveSplitCoreNative.FuzzyList_search(this.ptr, pattern, (UIntPtr)max).AsString();
            return result;
        }
    ...
    public class HotkeyConfigRef
    {
        ...
        public string SettingsDescriptionAsJson()
        {
            ...
            var result = LiveSplitCoreNative.HotkeyConfig_settings_description_as_json(this.ptr).AsString();
            return result;
        }
        /// <summary>
        ...
        public string AsJson()
        {
            ...
            var result = LiveSplitCoreNative.HotkeyConfig_as_json(this.ptr).AsString();
            return result;
        }
    ...
    public class SplitComponentStateRef
    {
        ...
        public long ColumnsLen(long index)
        {
            ...
            var result = (long)LiveSplitCoreNative.SplitComponentState_columns_len(this.ptr, (UIntPtr)index);
            return result;
        }
        internal SplitComponentStateRef(IntPtr ptr)
        {
            this.ptr = ptr;
        }
    }
    ...
    {
        internal SplitComponentStateRefMut(IntPtr ptr) : base(ptr) { }
    }

    /// <summary>
    /// The state object that describes a single segment's information to visualize.
    /// </summary>
    public class SplitComponentState : SplitComponentStateRefMut, IDisposable
    {
        private void Drop()
        {
            if (ptr != IntPtr.Zero)
        ...
        internal SplitComponentState(IntPtr ptr) : base(ptr) { }
    }
    ...
    public class SplitsComponentStateRef
    {
        ...
        public string IconChangeIcon(long iconChangeIndex)
        {
            ...
            var result = LiveSplitCoreNative.SplitsComponentState_icon_change_icon(this.ptr, (UIntPtr)iconChangeIndex).AsString();
            return result;
        }
        /// <summary>
        ...
        public string ColumnValue(long index, long columnIndex)
        {
            ...
            var result = LiveSplitCoreNative.SplitsComponentState_column_value(this.ptr, (UIntPtr)index, (UIntPtr)columnIndex).AsString();
            return result;
        }
        /// <summary>
        ...
        public string ColumnSemanticColor(long index, long columnIndex)
        {
            ...
            var result = LiveSplitCoreNative.SplitsComponentState_column_semantic_color(this.ptr, (UIntPtr)index, (UIntPtr)columnIndex).AsString();
            return result;
        }
        /// <summary>
    ...
    public class TimerRef
    {
        ...
        public string SaveAsLss()
        {
            ...
            var result = LiveSplitCoreNative.Timer_save_as_lss(this.ptr).AsString();
            return result;
        }
        /// <summary>
    ...
    public static class LiveSplitCoreNative
    {
        ...
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern LSCoreString FuzzyList_search(IntPtr self, string pattern, UIntPtr max);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern void FuzzyList_push(IntPtr self, string text);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr HotkeyConfig_parse_json(string settings);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RunEditor_set_run_id(IntPtr self, string name);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RunEditor_set_region_name(IntPtr self, string name);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RunEditor_set_platform_name(IntPtr self, string name);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RunEditor_set_emulator_usage(IntPtr self, bool uses_emulator);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RunEditor_set_variable(IntPtr self, string name, string value);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RunEditor_remove_variable(IntPtr self, string name);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RunEditor_active_set_name(IntPtr self, string name);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte RunEditor_active_parse_and_set_split_time(IntPtr self, string time);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte RunEditor_active_parse_and_set_segment_time(IntPtr self, string time);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte RunEditor_active_parse_and_set_best_segment_time(IntPtr self, string time);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte RunEditor_active_parse_and_set_comparison_time(IntPtr self, string comparison, string time);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr SettingValue_from_alignment(string value);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr SettingValue_from_column_start_with(string value);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr SettingValue_from_column_update_with(string value);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr SettingValue_from_column_update_trigger(string value);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern UIntPtr SplitComponentState_columns_len(IntPtr self, UIntPtr index);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern LSCoreString SplitsComponentState_icon_change_icon(IntPtr self, UIntPtr icon_change_index);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr TimeSpan_parse(string text);
        [DllImport("livesplit_core", CallingConvention = CallingConvention.Cdecl)]
