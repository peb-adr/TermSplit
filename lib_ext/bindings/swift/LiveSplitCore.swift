...
public class Analysis : AnalysisRefMut {
    ...
    */
    public static func calculateSumOfBest(_ run: RunRef, _ simpleCalculation: Bool, _ useCurrentRun: Bool, _ method: UInt8) -> TimeSpan? {
        ...
        let result = TimeSpan(ptr: LiveSplitCoreNative.Analysis_calculate_sum_of_best(run.ptr, simpleCalculation ? 1 : 0, useCurrentRun ? 1 : 0, method))
...
public class AtomicDateTimeRef {
    ...
    */
    public func isSynchronized() -> Bool {
        ...
        let result = LiveSplitCoreNative.AtomicDateTime_is_synchronized(self.ptr) != 0
        return result
    }
    /**
...
public class BlankSpaceComponentRefMut: BlankSpaceComponentRef {
    ...
    */
    public func stateAsJson(_ timer: TimerRef) -> String {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        let result = LiveSplitCoreNative.BlankSpaceComponent_state_as_json(self.ptr, timer.ptr)
        return String(cString: result!)
    }
    /**
        Calculates the component's state based on the timer provided.
    */
    public func state(_ timer: TimerRef) -> BlankSpaceComponentState {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        let result = BlankSpaceComponentState(ptr: LiveSplitCoreNative.BlankSpaceComponent_state(self.ptr, timer.ptr))
        return result
    }
    override init(ptr: UnsafeMutableRawPointer?) {
        super.init(ptr: ptr)
...
public class CurrentComparisonComponentRefMut: CurrentComparisonComponentRef {
    ...
    */
    ...
    /**
        Calculates the component's state based on the timer provided.
    */
    public func state(_ timer: TimerRef) -> CurrentComparisonComponentState {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        let result = CurrentComparisonComponentState(ptr: LiveSplitCoreNative.CurrentComparisonComponent_state(self.ptr, timer.ptr))
        return result
    }
    override init(ptr: UnsafeMutableRawPointer?) {
        super.init(ptr: ptr)
...
public class CurrentComparisonComponentStateRef {
    ...
    */
    public func text() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.CurrentComparisonComponentState_text(self.ptr)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func comparison() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.CurrentComparisonComponentState_comparison(self.ptr)
        return String(cString: result!)
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    The state object describes the information to visualize for this component.
*/
public class CurrentComparisonComponentState : CurrentComparisonComponentStateRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.CurrentComparisonComponentState_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
...
public class CurrentPaceComponentRefMut: CurrentPaceComponentRef {
    ...
    */
    ...
    /**
        Calculates the component's state based on the timer provided.
    */
    public func state(_ timer: TimerRef) -> CurrentPaceComponentState {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        let result = CurrentPaceComponentState(ptr: LiveSplitCoreNative.CurrentPaceComponent_state(self.ptr, timer.ptr))
        return result
    }
    override init(ptr: UnsafeMutableRawPointer?) {
        super.init(ptr: ptr)
...
public class CurrentPaceComponentStateRef {
    ...
    */
    public func text() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.CurrentPaceComponentState_text(self.ptr)
        return String(cString: result!)
    }
    /**
        The current pace.
    */
    public func time() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.CurrentPaceComponentState_time(self.ptr)
        return String(cString: result!)
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    The state object describes the information to visualize for this component.
*/
public class CurrentPaceComponentState : CurrentPaceComponentStateRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.CurrentPaceComponentState_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
...
public class DeltaComponentRefMut: DeltaComponentRef {
    ...
    */
    ...
    /**
        ...
        settings provided.
    */
    public func state(_ timer: TimerRef, _ layoutSettings: GeneralLayoutSettingsRef) -> DeltaComponentState {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        assert(layoutSettings.ptr != Optional.none)
        let result = DeltaComponentState(ptr: LiveSplitCoreNative.DeltaComponent_state(self.ptr, timer.ptr, layoutSettings.ptr))
        return result
    }
    override init(ptr: UnsafeMutableRawPointer?) {
        super.init(ptr: ptr)
...
public class DeltaComponentStateRef {
    ...
    */
    public func text() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.DeltaComponentState_text(self.ptr)
        return String(cString: result!)
    }
    /**
        The delta.
    */
    public func time() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.DeltaComponentState_time(self.ptr)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func semanticColor() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.DeltaComponentState_semantic_color(self.ptr)
        return String(cString: result!)
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    The state object describes the information to visualize for this component.
*/
public class DeltaComponentState : DeltaComponentStateRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.DeltaComponentState_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
...
public class DetailedTimerComponentStateRef {
    ...
    */
    public func comparison1Visible() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.DetailedTimerComponentState_comparison1_visible(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func comparison2Visible() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.DetailedTimerComponentState_comparison2_visible(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func iconChange() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.DetailedTimerComponentState_icon_change(self.ptr)
        return String(cString: result!)
    }
    /**
...
public class GraphComponentStateRef {
    ...
    */
    public func pointIsBestSegment(_ index: size_t) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.GraphComponentState_point_is_best_segment(self.ptr, index) != 0
        return result
    }
    /**
    ...
    */
    public func isLiveDeltaActive() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.GraphComponentState_is_live_delta_active(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func isFlipped() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.GraphComponentState_is_flipped(self.ptr) != 0
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class HotkeyConfigRefMut: HotkeyConfigRef {
    ...
    */
    public func setValue(_ index: size_t, _ value: SettingValue) -> Bool {
        ...
        let result = LiveSplitCoreNative.HotkeyConfig_set_value(self.ptr, index, value.ptr) != 0
...
public class HotkeySystemRef {
    ...
    */
    public func deactivate() {
        assert(self.ptr != Optional.none)
        LiveSplitCoreNative.HotkeySystem_deactivate(self.ptr)
    }
    /**
    ...
    */
    public func activate() {
        assert(self.ptr != Optional.none)
        LiveSplitCoreNative.HotkeySystem_activate(self.ptr)
    }
    /**
...
public class HotkeySystemRefMut: HotkeySystemRef {
    ...
    */
    public func setConfig(_ config: HotkeyConfig) -> Bool {
        ...
        let result = LiveSplitCoreNative.HotkeySystem_set_config(self.ptr, config.ptr) != 0
...
public class ParseRunResultRef {
    ...
    */
    public func parsedSuccessfully() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.ParseRunResult_parsed_successfully(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func isGenericTimer() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.ParseRunResult_is_generic_timer(self.ptr) != 0
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class PossibleTimeSaveComponentRef {
    ...
    */
    ...
    /**
        Calculates the component's state based on the timer provided.
    */
    public func state(_ timer: TimerRef) -> PossibleTimeSaveComponentState {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        let result = PossibleTimeSaveComponentState(ptr: LiveSplitCoreNative.PossibleTimeSaveComponent_state(self.ptr, timer.ptr))
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class PossibleTimeSaveComponentStateRef {
    ...
    */
    public func text() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.PossibleTimeSaveComponentState_text(self.ptr)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func time() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.PossibleTimeSaveComponentState_time(self.ptr)
        return String(cString: result!)
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    The state object describes the information to visualize for this component.
*/
public class PossibleTimeSaveComponentState : PossibleTimeSaveComponentStateRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.PossibleTimeSaveComponentState_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
...
public class PreviousSegmentComponentRef {
    ...
    */
    ...
    /**
        ...
        settings provided.
    */
    public func state(_ timer: TimerRef, _ layoutSettings: GeneralLayoutSettingsRef) -> PreviousSegmentComponentState {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        assert(layoutSettings.ptr != Optional.none)
        let result = PreviousSegmentComponentState(ptr: LiveSplitCoreNative.PreviousSegmentComponent_state(self.ptr, timer.ptr, layoutSettings.ptr))
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class PreviousSegmentComponentStateRef {
    ...
    */
    public func text() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.PreviousSegmentComponentState_text(self.ptr)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func time() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.PreviousSegmentComponentState_time(self.ptr)
        return String(cString: result!)
    }
    /**
        The semantic coloring information the delta time carries.
    */
    public func semanticColor() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.PreviousSegmentComponentState_semantic_color(self.ptr)
        return String(cString: result!)
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    The state object describes the information to visualize for this component.
*/
public class PreviousSegmentComponentState : PreviousSegmentComponentStateRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.PreviousSegmentComponentState_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
...
public class RunRef {
    ...
    */
    public func gameIcon() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.Run_game_icon(self.ptr)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func extendedFileName(_ useExtendedCategoryName: Bool) -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.Run_extended_file_name(self.ptr, useExtendedCategoryName ? 1 : 0)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func extendedName(_ useExtendedCategoryName: Bool) -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.Run_extended_name(self.ptr, useExtendedCategoryName ? 1 : 0)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func extendedCategoryName(_ showRegion: Bool, _ showPlatform: Bool, _ showVariables: Bool) -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.Run_extended_category_name(self.ptr, showRegion ? 1 : 0, showPlatform ? 1 : 0, showVariables ? 1 : 0)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func hasBeenModified() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.Run_has_been_modified(self.ptr) != 0
        return result
    }
    /**
...
public class Run : RunRefMut {
    ...
    */
    public static func parse(_ data: UnsafeMutableRawPointer?, _ length: size_t, _ path: String, _ loadFiles: Bool) -> ParseRunResult {
        let result = ParseRunResult(ptr: LiveSplitCoreNative.Run_parse(data, length, path, loadFiles ? 1 : 0))
        return result
    }
    /**
    ...
    */
    public static func parseFileHandle(_ handle: Int64, _ path: String, _ loadFiles: Bool) -> ParseRunResult {
        let result = ParseRunResult(ptr: LiveSplitCoreNative.Run_parse_file_handle(handle, path, loadFiles ? 1 : 0))
        return result
    }
    override init(ptr: UnsafeMutableRawPointer?) {
        super.init(ptr: ptr)
...
public class RunEditorRefMut: RunEditorRef {
    ...
    */
    public func parseAndSetOffset(_ offset: String) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_parse_and_set_offset(self.ptr, offset) != 0
        return result
    }
    /**
    ...
    */
    public func parseAndSetAttemptCount(_ attempts: String) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_parse_and_set_attempt_count(self.ptr, attempts) != 0
        return result
    }
    /**
    ...
    */
    public func setEmulatorUsage(_ usesEmulator: Bool) {
        assert(self.ptr != Optional.none)
        LiveSplitCoreNative.RunEditor_set_emulator_usage(self.ptr, usesEmulator ? 1 : 0)
    }
    /**
    ...
    */
    public func setVariable(_ name: String, _ value: String) {
        assert(self.ptr != Optional.none)
        LiveSplitCoreNative.RunEditor_set_variable(self.ptr, name, value)
    }
    /**
        Removes the variable with the name specified.
    */
    public func removeVariable(_ name: String) {
        assert(self.ptr != Optional.none)
        LiveSplitCoreNative.RunEditor_remove_variable(self.ptr, name)
    }
    /**
    ...
    */
    public func activeParseAndSetSplitTime(_ time: String) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_active_parse_and_set_split_time(self.ptr, time) != 0
        return result
    }
    /**
    ...
    */
    public func activeParseAndSetSegmentTime(_ time: String) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_active_parse_and_set_segment_time(self.ptr, time) != 0
        return result
    }
    /**
    ...
    */
    public func activeParseAndSetBestSegmentTime(_ time: String) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_active_parse_and_set_best_segment_time(self.ptr, time) != 0
        return result
    }
    /**
    ...
    */
    public func activeParseAndSetComparisonTime(_ comparison: String, _ time: String) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_active_parse_and_set_comparison_time(self.ptr, comparison, time) != 0
        return result
    }
    /**
    ...
    */
    public func addComparison(_ comparison: String) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_add_comparison(self.ptr, comparison) != 0
        return result
    }
    /**
    ...
    */
    public func importComparison(_ run: RunRef, _ comparison: String) -> Bool {
        assert(self.ptr != Optional.none)
        assert(run.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_import_comparison(self.ptr, run.ptr, comparison) != 0
        return result
    }
    /**
    ...
    */
    public func renameComparison(_ oldName: String, _ newName: String) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_rename_comparison(self.ptr, oldName, newName) != 0
        return result
    }
    /**
    ...
    */
    public func moveComparison(_ srcIndex: size_t, _ dstIndex: size_t) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunEditor_move_comparison(self.ptr, srcIndex, dstIndex) != 0
        return result
    }
    /**
...
public class RunMetadataRef {
    ...
    */
    public func usesEmulator() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunMetadata_uses_emulator(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func variables() -> RunMetadataVariablesIter {
        assert(self.ptr != Optional.none)
        let result = RunMetadataVariablesIter(ptr: LiveSplitCoreNative.RunMetadata_variables(self.ptr))
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class RunMetadataVariableRef {
    ...
    */
    public func name() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunMetadataVariable_name(self.ptr)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func value() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.RunMetadataVariable_value(self.ptr)
        return String(cString: result!)
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    ...
    are used in the category.
*/
public class RunMetadataVariable : RunMetadataVariableRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.RunMetadataVariable_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
...
public class RunMetadataVariablesIterRefMut: RunMetadataVariablesIterRef {
    /**
        ...
        variables.
    */
    public func next() -> RunMetadataVariableRef? {
        assert(self.ptr != Optional.none)
        let result = RunMetadataVariableRef(ptr: LiveSplitCoreNative.RunMetadataVariablesIter_next(self.ptr))
        if result.ptr == Optional.none {
            return Optional.none
        }
        return result
...
/**
    ...
    that have been specified.
*/
public class RunMetadataVariablesIter : RunMetadataVariablesIterRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.RunMetadataVariablesIter_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
...
public class SegmentRef {
    ...
    */
    public func icon() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.Segment_icon(self.ptr)
        return String(cString: result!)
    }
    /**
...
public class SettingValue : SettingValueRefMut {
    ...
    */
    public static func fromBool(_ value: Bool) -> SettingValue {
        let result = SettingValue(ptr: LiveSplitCoreNative.SettingValue_from_bool(value ? 1 : 0))
        return result
    }
    /**
...
public class SplitComponentStateRef {
    ...
    */
    public func columnsLen(_ index: size_t) -> size_t {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.SplitComponentState_columns_len(self.ptr, index)
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    The state object that describes a single segment's information to visualize.
*/
public class SplitComponentStateRefMut: SplitComponentStateRef {
    override init(ptr: UnsafeMutableRawPointer?) {
        super.init(ptr: ptr)
    }
}
...
/**
    The state object that describes a single segment's information to visualize.
*/
public class SplitComponentState : SplitComponentStateRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            self.ptr = Optional.none
        }
...
public class SplitsComponentRefMut: SplitsComponentRef {
    ...
    */
    public func setAlwaysShowLastSplit(_ alwaysShowLastSplit: Bool) {
        assert(self.ptr != Optional.none)
        LiveSplitCoreNative.SplitsComponent_set_always_show_last_split(self.ptr, alwaysShowLastSplit ? 1 : 0)
    }
    /**
    ...
    */
    public func setSeparatorLastSplit(_ separatorLastSplit: Bool) {
        assert(self.ptr != Optional.none)
        LiveSplitCoreNative.SplitsComponent_set_separator_last_split(self.ptr, separatorLastSplit ? 1 : 0)
    }
    override init(ptr: UnsafeMutableRawPointer?) {
        super.init(ptr: ptr)
    }
...
public class SplitsComponentStateRef {
    ...
    */
    public func finalSeparatorShown() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.SplitsComponentState_final_separator_shown(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func iconChangeIcon(_ iconChangeIndex: size_t) -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.SplitsComponentState_icon_change_icon(self.ptr, iconChangeIndex)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func isCurrentSplit(_ index: size_t) -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.SplitsComponentState_is_current_split(self.ptr, index) != 0
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class SumOfBestComponentRef {
    ...
    */
    ...
    /**
        Calculates the component's state based on the timer provided.
    */
    public func state(_ timer: TimerRef) -> SumOfBestComponentState {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        let result = SumOfBestComponentState(ptr: LiveSplitCoreNative.SumOfBestComponent_state(self.ptr, timer.ptr))
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class SumOfBestComponentStateRef {
    ...
    */
    public func text() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.SumOfBestComponentState_text(self.ptr)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func time() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.SumOfBestComponentState_time(self.ptr)
        return String(cString: result!)
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    The state object describes the information to visualize for this component.
*/
public class SumOfBestComponentState : SumOfBestComponentStateRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.SumOfBestComponentState_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
...
public class TextComponentRef {
    ...
    */
    public func stateAsJson() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.TextComponent_state_as_json(self.ptr)
        return String(cString: result!)
    }
    /**
        Calculates the component's state.
    */
    public func state() -> TextComponentState {
        assert(self.ptr != Optional.none)
        let result = TextComponentState(ptr: LiveSplitCoreNative.TextComponent_state(self.ptr))
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class TextComponentStateRef {
    ...
    */
    public func isSplit() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.TextComponentState_is_split(self.ptr) != 0
        return result
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
public class TimerRef {
    ...
    */
    public func isGameTimeInitialized() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.Timer_is_game_time_initialized(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func isGameTimePaused() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.Timer_is_game_time_paused(self.ptr) != 0
        return result
    }
    /**
...
public class TimerRefMut: TimerRef {
    ...
    */
    public func replaceRun(_ run: RunRefMut, _ updateSplits: Bool) -> Bool {
        assert(self.ptr != Optional.none)
        assert(run.ptr != Optional.none)
        let result = LiveSplitCoreNative.Timer_replace_run(self.ptr, run.ptr, updateSplits ? 1 : 0) != 0
        return result
    }
    /**
    ...
    */
    public func reset(_ updateSplits: Bool) {
        assert(self.ptr != Optional.none)
        LiveSplitCoreNative.Timer_reset(self.ptr, updateSplits ? 1 : 0)
    }
    /**
...
public class Timer : TimerRefMut {
    ...
    */
    public func intoRun(_ updateSplits: Bool) -> Run {
        assert(self.ptr != Optional.none)
        let result = Run(ptr: LiveSplitCoreNative.Timer_into_run(self.ptr, updateSplits ? 1 : 0))
        self.ptr = Optional.none
        return result
    }
    override init(ptr: UnsafeMutableRawPointer?) {
...
public class TitleComponentStateRef {
    ...
    */
    public func iconChange() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.TitleComponentState_icon_change(self.ptr)
        return String(cString: result!)
    }
    /**
    ...
    */
    public func isCentered() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.TitleComponentState_is_centered(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func showsFinishedRuns() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.TitleComponentState_shows_finished_runs(self.ptr) != 0
        return result
    }
    /**
    ...
    */
    public func showsAttempts() -> Bool {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.TitleComponentState_shows_attempts(self.ptr) != 0
        return result
    }
    /**
...
public class TotalPlaytimeComponentRefMut: TotalPlaytimeComponentRef {
    ...
    */
    ...
    /**
        Calculates the component's state based on the timer provided.
    */
    public func state(_ timer: TimerRef) -> TotalPlaytimeComponentState {
        assert(self.ptr != Optional.none)
        assert(timer.ptr != Optional.none)
        let result = TotalPlaytimeComponentState(ptr: LiveSplitCoreNative.TotalPlaytimeComponent_state(self.ptr, timer.ptr))
        return result
    }
    override init(ptr: UnsafeMutableRawPointer?) {
        super.init(ptr: ptr)
...
public class TotalPlaytimeComponentStateRef {
    ...
    */
    public func text() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.TotalPlaytimeComponentState_text(self.ptr)
        return String(cString: result!)
    }
    /**
        The total playtime.
    */
    public func time() -> String {
        assert(self.ptr != Optional.none)
        let result = LiveSplitCoreNative.TotalPlaytimeComponentState_time(self.ptr)
        return String(cString: result!)
    }
    init(ptr: UnsafeMutableRawPointer?) {
        self.ptr = ptr
...
/**
    The state object describes the information to visualize for this component.
*/
public class TotalPlaytimeComponentState : TotalPlaytimeComponentStateRefMut {
    private func drop() {
        if self.ptr != Optional.none {
            LiveSplitCoreNative.TotalPlaytimeComponentState_drop(self.ptr)
            self.ptr = Optional.none
        }
    }
    deinit {
